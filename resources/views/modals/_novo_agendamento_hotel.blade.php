<div class="modal fade" id="modal_novo_agendamento_hotel" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-xl modal-dialog-scrollable">
        <div class="modal-header">
            <h5 class="modal-title d-flex align-items-center">
                <img src='/logo_simples_branco_laranja.svg' alt='Logo Diprosoft' width='40' height='28' />
                Nova Reserva de Hotel
        ...
        <div class="modal-content">
            <div class="modal-body p-3">
                ...
                {!! 
                    Form::open() 
                    ->id('form-novo-agendamento-hotel')
                    ->post()
                !!}
            ...
            <div class="modal-footer">
                <div class="d-flex col-12 align-items-center justify-content-end gap-2 new-colors">
                    ...
                    <button 
                        ...
                        id="submit_novo_agendamento_hotel"
                    >
                        Salvar
                    </button>
                </div>
