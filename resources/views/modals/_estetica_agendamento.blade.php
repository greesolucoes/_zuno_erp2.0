<div class="modal fade modal-config" id="selectHorarioModal" data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable modal-md" style="height: max-content;">
        <div class="modal-content border-0 rounded-3">
            <div class="modal-header">
                <h5 class="modal-title d-flex align-items-center" id="selectHorarioModalTitle">
