...
return new class extends Migration
{
    ...
    {
        Schema::dropIfExists('petshop_animais_consultas');
        Schema::dropIfExists('petshop_animais_diagnosticos');
        Schema::dropIfExists('petshop_animais_exames');
        Schema::dropIfExists('petshop_animais');
        Schema::dropIfExists('petshop_animais_pelagens');
        Schema::dropIfExists('petshop_animais_racas');
        Schema::dropIfExists('petshop_animais_especies');
    }
