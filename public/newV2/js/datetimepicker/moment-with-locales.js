...
// author : Werner Mollentze : https://github.com/wernerm
    ...
    (function (factory) {
        ...
        return moment.defineLocale('af', {
            ...
            ordinal: function (number) {
                return number + ((number === 1 || number === 8 || number >= 20) ? 'ste' : 'de'); // Thanks to Joris Rà¶ling : https://github.com/jjupiter
            },
            week: {
...
// author : topchiyev : https://github.com/topchiyev
    ...
    (function (factory) {
        ...
        return moment.defineLocale('az', {
            ...
            weekdays: 'Bazar_Bazar ertÉ™si_à‡É™rÅŸÉ™nbÉ™ axÅŸamÄ±_à‡É™rÅŸÉ™nbÉ™_Cà¼mÉ™ axÅŸamÄ±_Cà¼mÉ™_ÅžÉ™nbÉ™'.split('_'),
            weekdaysShort: 'Baz_BzE_à‡Ax_à‡É™r_CAx_Cà¼m_ÅžÉ™n'.split('_'),
            weekdaysMin: 'Bz_BE_à‡A_à‡É™_CA_Cà¼_ÅžÉ™'.split('_'),
            longDateFormat: {
                LT: 'HH:mm',
                LTS: 'LT:ss',
                L: 'DD.MM.YYYY',
            ...
            calendar: {
                sameDay: '[bugà¼n saat] LT',
                nextDay: '[sabah saat] LT',
                nextWeek: '[gÉ™lÉ™n hÉ™ftÉ™] dddd [saat] LT',
                lastDay: '[dà¼nÉ™n] LT',
                lastWeek: '[keçÉ™n hÉ™ftÉ™] dddd [saat] LT',
                sameElse: 'L'
            },
            relativeTime: {
                future: '%s sonra',
            ...
            meridiemParse: /gecÉ™|sÉ™hÉ™r|gà¼ndà¼z|axÅŸam/,
            isPM: function (input) {
                return /^(gà¼ndà¼z|axÅŸam)$/.test(input);
            },
            meridiem: function (hour, minute, isLower) {
                if (hour < 4) {
                    return 'gecÉ™';
            ...
            ordinalParse: /\d{1,2}-(Ä±ncÄ±|inci|nci|à¼ncà¼|ncÄ±|uncu)/,
            ordinal: function (number) {
...
// Author : Menelion Elensàºle : https://github.com/Oire
...
// author : Jean-Baptiste Le Duigou : https://github.com/jbleduigou
    ...
    (function (factory) {
        ...
        return moment.defineLocale('br', {
            ...
            ordinalParse: /\d{1,2}(aà±|vet)/,
            ordinal: function (number) {
                var output = (number === 1) ? 'aà±' : 'vet';
                return number + output;
            },
            week: {
                dow: 1, // Monday is the first day of the week.
...
// author : petrbela : https://github.com/petrbela
    ...
    (function (factory) {
        ...
        var months = 'leden_àºnor_bÅ™ezen_duben_kvÄ›ten_Ä?erven_Ä?ervenec_srpen_záÅ™à­_Å™à­jen_listopad_prosinec'.split('_'),
                monthsShort = 'led_àºno_bÅ™e_dub_kvÄ›_Ä?vn_Ä?vc_srp_záÅ™_Å™à­j_lis_pro'.split('_');
        ...
        function translate(number, withoutSuffix, key, isFuture) {
            ...
            switch (key) {
                ...
                case 'dd': // 9 days / in 9 days / 9 days ago
                    if (withoutSuffix || isFuture) {
                        return result + (plural(number) ? 'dny' : 'dnà­');
                    } else {
                        return result + 'dny';
                    }
                    break;
                case 'M':  // a month / in a month / a month ago
                    return (withoutSuffix || isFuture) ? 'mÄ›sà­c' : 'mÄ›sà­cem';
                case 'MM': // 9 months / in 9 months / 9 months ago
                    if (withoutSuffix || isFuture) {
                        return result + (plural(number) ? 'mÄ›sà­ce' : 'mÄ›sà­cÅ¯');
                    } else {
                        return result + 'mÄ›sà­ci';
                    }
                    break;
        ...
        return moment.defineLocale('cs', {
            ...
            weekdays: 'nedÄ›le_pondÄ›là­_àºterà½_stÅ™eda_Ä?tvrtek_pátek_sobota'.split('_'),
            weekdaysShort: 'ne_po_àºt_st_Ä?t_pá_so'.split('_'),
            weekdaysMin: 'ne_po_àºt_st_Ä?t_pá_so'.split('_'),
            longDateFormat: {
                LT: 'H:mm',
                LTS: 'LT:ss',
                L: 'DD.MM.YYYY',
...
// author : Anatoly Mironov : https://github.com/mirontoli
    ...
    (function (factory) {
        ...
        return moment.defineLocale('cv', {
            months: 'ÐºÄƒÑ€Ð»Ð°Ñ‡_Ð½Ð°Ñ€ÄƒÑ?_Ð¿ÑƒÑˆ_Ð°ÐºÐ°_Ð¼Ð°Ð¹_çÄ•Ñ€Ñ‚Ð¼Ðµ_ÑƒÑ‚Äƒ_çÑƒÑ€Ð»Ð°_Ð°Ð²ÄƒÐ½_ÑŽÐ¿Ð°_Ñ‡Ó³Ðº_Ñ€Ð°ÑˆÑ‚Ð°Ð²'.split('_'),
            monthsShort: 'ÐºÄƒÑ€_Ð½Ð°Ñ€_Ð¿ÑƒÑˆ_Ð°ÐºÐ°_Ð¼Ð°Ð¹_çÄ•Ñ€_ÑƒÑ‚Äƒ_çÑƒÑ€_Ð°Ð²_ÑŽÐ¿Ð°_Ñ‡Ó³Ðº_Ñ€Ð°Ñˆ'.split('_'),
            weekdays: 'Ð²Ñ‹Ñ€Ñ?Ð°Ñ€Ð½Ð¸ÐºÑƒÐ½_Ñ‚ÑƒÐ½Ñ‚Ð¸ÐºÑƒÐ½_Ñ‹Ñ‚Ð»Ð°Ñ€Ð¸ÐºÑƒÐ½_ÑŽÐ½ÐºÑƒÐ½_ÐºÄ•çÐ½ÐµÑ€Ð½Ð¸ÐºÑƒÐ½_Ñ?Ñ€Ð½ÐµÐºÑƒÐ½_ÑˆÄƒÐ¼Ð°Ñ‚ÐºÑƒÐ½'.split('_'),
            weekdaysShort: 'Ð²Ñ‹Ñ€_Ñ‚ÑƒÐ½_Ñ‹Ñ‚Ð»_ÑŽÐ½_ÐºÄ•ç_Ñ?Ñ€Ð½_ÑˆÄƒÐ¼'.split('_'),
            weekdaysMin: 'Ð²Ñ€_Ñ‚Ð½_Ñ‹Ñ‚_ÑŽÐ½_Ðºç_Ñ?Ñ€_ÑˆÐ¼'.split('_'),
            longDateFormat: {
                LT: 'HH:mm',
                LTS: 'LT:ss',
                L: 'DD-MM-YYYY',
                LL: 'YYYY [çÑƒÐ»Ñ…Ð¸] MMMM [ÑƒÐ¹ÄƒÑ…Ä•Ð½] D[-Ð¼Ä•ÑˆÄ•]',
                LLL: 'YYYY [çÑƒÐ»Ñ…Ð¸] MMMM [ÑƒÐ¹ÄƒÑ…Ä•Ð½] D[-Ð¼Ä•ÑˆÄ•], LT',
                LLLL: 'dddd, YYYY [çÑƒÐ»Ñ…Ð¸] MMMM [ÑƒÐ¹ÄƒÑ…Ä•Ð½] D[-Ð¼Ä•ÑˆÄ•], LT'
            },
            calendar: {
                sameDay: '[ÐŸÐ°Ñ?Ð½] LT [Ñ?ÐµÑ…ÐµÑ‚Ñ€Ðµ]',
                nextDay: '[Ð«Ñ€Ð°Ð½] LT [Ñ?ÐµÑ…ÐµÑ‚Ñ€Ðµ]',
                lastDay: '[Ä”Ð½ÐµÑ€] LT [Ñ?ÐµÑ…ÐµÑ‚Ñ€Ðµ]',
                nextWeek: '[à‡Ð¸Ñ‚ÐµÑ?] dddd LT [Ñ?ÐµÑ…ÐµÑ‚Ñ€Ðµ]',
                lastWeek: '[Ð˜Ñ€Ñ‚Ð½Ä•] dddd LT [Ñ?ÐµÑ…ÐµÑ‚Ñ€Ðµ]',
                sameElse: 'L'
            },
            relativeTime: {
                future: function (output) {
                    var affix = /Ñ?ÐµÑ…ÐµÑ‚$/i.exec(output) ? 'Ñ€ÐµÐ½' : /çÑƒÐ»$/i.exec(output) ? 'Ñ‚Ð°Ð½' : 'Ñ€Ð°Ð½';
                    return output + affix;
                },
                past: '%s ÐºÐ°Ñ?Ð»Ð»Ð°',
                s: 'Ð¿Ä•Ñ€-Ð¸Ðº çÐµÐºÐºÑƒÐ½Ñ‚',
                m: 'Ð¿Ä•Ñ€ Ð¼Ð¸Ð½ÑƒÑ‚',
                mm: '%d Ð¼Ð¸Ð½ÑƒÑ‚',
                h: 'Ð¿Ä•Ñ€ Ñ?ÐµÑ…ÐµÑ‚',
                hh: '%d Ñ?ÐµÑ…ÐµÑ‚',
...
// author : Ulrik Nielsen : https://github.com/mrbase
    ...
    (function (factory) {
        ...
        return moment.defineLocale('da', {
            ...
            weekdays: 'sà¸ndag_mandag_tirsdag_onsdag_torsdag_fredag_là¸rdag'.split('_'),
            weekdaysShort: 'sà¸n_man_tir_ons_tor_fre_là¸r'.split('_'),
            weekdaysMin: 'sà¸_ma_ti_on_to_fr_là¸'.split('_'),
            longDateFormat: {
                LT: 'HH:mm',
                LTS: 'LT:ss',
                L: 'DD/MM/YYYY',
...
// author : Martin Groller : https://github.com/MadMG
    ...
    (function (factory) {
        ...
        return moment.defineLocale('de-at', {
            months: 'Jà¤nner_Februar_Mà¤rz_April_Mai_Juni_Juli_August_September_Oktober_November_Dezember'.split('_'),
            monthsShort: 'Jà¤n._Febr._Mrz._Apr._Mai_Jun._Jul._Aug._Sept._Okt._Nov._Dez.'.split('_'),
...
// author: Menelion Elensàºle: https://github.com/Oire
    ...
    (function (factory) {
        ...
        return moment.defineLocale('de', {
            months: 'Januar_Februar_Mà¤rz_April_Mai_Juni_Juli_August_September_Oktober_November_Dezember'.split('_'),
...
// author : Julio Napurà­ : https://github.com/julionc
    ...
    (function (factory) {
        ...
        return moment.defineLocale('es', {
            ...
            weekdays: 'domingo_lunes_martes_mià©rcoles_jueves_viernes_sábado'.split('_'),
            weekdaysShort: 'dom._lun._mar._mià©._jue._vie._sáb.'.split('_'),
            ...
            calendar: {
                ...
                nextDay: function () {
                    return '[maà±ana a la' + ((this.hours() !== 1) ? 's' : '') + '] LT';
                },
                nextWeek: function () {
...
// improvements : Illimar Tambek : https://github.com/ragulka
    ...
    (function (factory) {
        ...
        function processRelativeTime(number, withoutSuffix, key, isFuture) {
            var format = {
                's': ['màµne sekundi', 'màµni sekund', 'paar sekundit'],
                'm': ['à¼he minuti', 'à¼ks minut'],
                'mm': [number + ' minuti', number + ' minutit'],
                'h': ['à¼he tunni', 'tund aega', 'à¼ks tund'],
                'hh': [number + ' tunni', number + ' tundi'],
                'd': ['à¼he pà¤eva', 'à¼ks pà¤ev'],
                'M': ['kuu aja', 'kuu aega', 'à¼ks kuu'],
                'MM': [number + ' kuu', number + ' kuud'],
                'y': ['à¼he aasta', 'aasta', 'à¼ks aasta'],
        ...
        return moment.defineLocale('et', {
            months: 'jaanuar_veebruar_mà¤rts_aprill_mai_juuni_juuli_august_september_oktoober_november_detsember'.split('_'),
            monthsShort: 'jaan_veebr_mà¤rts_apr_mai_juuni_juuli_aug_sept_okt_nov_dets'.split('_'),
            weekdays: 'pà¼hapà¤ev_esmaspà¤ev_teisipà¤ev_kolmapà¤ev_neljapà¤ev_reede_laupà¤ev'.split('_'),
...
// author : Tarmo Aidantausta : https://github.com/bleadof
    ...
    (function (factory) {
        ...
        var numbersPast = 'nolla yksi kaksi kolme neljà¤ viisi kuusi seitsemà¤n kahdeksan yhdeksà¤n'.split(' '),
                numbersFuture = [
                    'nolla', 'yhden', 'kahden', 'kolmen', 'neljà¤n', 'viiden', 'kuuden',
        ...
        function translate(number, withoutSuffix, key, isFuture) {
            ...
            switch (key) {
                ...
                case 'hh':
                    ...
                    break;
                case 'd':
                    return isFuture ? 'pà¤ivà¤n' : 'pà¤ivà¤';
                case 'dd':
                    result = isFuture ? 'pà¤ivà¤n' : 'pà¤ivà¤à¤';
                    break;
                case 'M':
        ...
        return moment.defineLocale('fi', {
            months: 'tammikuu_helmikuu_maaliskuu_huhtikuu_toukokuu_kesà¤kuu_heinà¤kuu_elokuu_syyskuu_lokakuu_marraskuu_joulukuu'.split('_'),
            monthsShort: 'tammi_helmi_maalis_huhti_touko_kesà¤_heinà¤_elo_syys_loka_marras_joulu'.split('_'),
...
// author : Ragnar Johannesen : https://github.com/ragnar123
    ...
    (function (factory) {
        ...
        return moment.defineLocale('fo', {
            months: 'januar_februar_mars_aprà­l_mai_juni_juli_august_september_oktober_november_desember'.split('_'),
            monthsShort: 'jan_feb_mar_apr_mai_jun_jul_aug_sep_okt_nov_des'.split('_'),
            weekdays: 'sunnudagur_mánadagur_tà½sdagur_mikudagur_hà³sdagur_frà­ggjadagur_leygardagur'.split('_'),
            weekdaysShort: 'sun_mán_tà½s_mik_hà³s_frà­_ley'.split('_'),
            weekdaysMin: 'su_má_tà½_mi_hà³_fr_le'.split('_'),
            longDateFormat: {
                LT: 'HH:mm',
                LTS: 'LT:ss',
                L: 'DD/MM/YYYY',
...
// author : Jonathan Abourbih : https://github.com/jonbca
    ...
    (function (factory) {
        ...
        return moment.defineLocale('fr-ca', {
            months: 'janvier_fà©vrier_mars_avril_mai_juin_juillet_aoà»t_septembre_octobre_novembre_dà©cembre'.split('_'),
            monthsShort: 'janv._fà©vr._mars_avr._mai_juin_juil._aoà»t_sept._oct._nov._dà©c.'.split('_'),
...
// author : Juan G. Hurtado : https://github.com/juanghurtado
    ...
    (function (factory) {
        ...
        return moment.defineLocale('gl', {
            months: 'Xaneiro_Febreiro_Marzo_Abril_Maio_Xuà±o_Xullo_Agosto_Setembro_Outubro_Novembro_Decembro'.split('_'),
            monthsShort: 'Xan._Feb._Mar._Abr._Mai._Xuà±._Xul._Ago._Set._Out._Nov._Dec.'.split('_'),
            weekdays: 'Domingo_Luns_Martes_Mà©rcores_Xoves_Venres_Sábado'.split('_'),
            weekdaysShort: 'Dom._Lun._Mar._Mà©r._Xov._Ven._Sáb.'.split('_'),
            weekdaysMin: 'Do_Lu_Ma_Mà©_Xo_Ve_Sá'.split('_'),
            longDateFormat: {
                LT: 'H:mm',
                LTS: 'LT:ss',
                L: 'DD/MM/YYYY',
            ...
            calendar: {
                ...
                nextDay: function () {
                    return '[maà±á ' + ((this.hours() !== 1) ? 'ás' : 'á') + '] LT';
                },
                nextWeek: function () {
...
// author : Adam Brunner : https://github.com/adambrunner
    ...
    (function (factory) {
        ...
        var weekEndings = 'vasárnap hà©tfÅ‘n kedden szerdán csà¼tà¶rtà¶kà¶n pà©nteken szombaton'.split(' ');
        ...
        function translate(number, withoutSuffix, key, isFuture) {
            ...
            switch (key) {
                case 's':
                    return (isFuture || withoutSuffix) ? 'nà©hány másodperc' : 'nà©hány másodperce';
                case 'm':
                    return 'egy' + (isFuture || withoutSuffix ? ' perc' : ' perce');
                case 'mm':
                    return num + (isFuture || withoutSuffix ? ' perc' : ' perce');
                case 'h':
                    return 'egy' + (isFuture || withoutSuffix ? ' à³ra' : ' à³rája');
                case 'hh':
                    return num + (isFuture || withoutSuffix ? ' à³ra' : ' à³rája');
                case 'd':
                    return 'egy' + (isFuture || withoutSuffix ? ' nap' : ' napja');
                case 'dd':
                    return num + (isFuture || withoutSuffix ? ' nap' : ' napja');
                case 'M':
                    return 'egy' + (isFuture || withoutSuffix ? ' hà³nap' : ' hà³napja');
                case 'MM':
                    return num + (isFuture || withoutSuffix ? ' hà³nap' : ' hà³napja');
                case 'y':
                    return 'egy' + (isFuture || withoutSuffix ? ' à©v' : ' à©ve');
                case 'yy':
                    return num + (isFuture || withoutSuffix ? ' à©v' : ' à©ve');
            }
        ...
        function week(isFuture) {
            return (isFuture ? '' : '[màºlt] ') + '[' + weekEndings[this.day()] + '] LT[-kor]';
        }

        return moment.defineLocale('hu', {
            months: 'január_február_március_április_május_jàºnius_jàºlius_augusztus_szeptember_oktà³ber_november_december'.split('_'),
            monthsShort: 'jan_feb_márc_ápr_máj_jàºn_jàºl_aug_szept_okt_nov_dec'.split('_'),
            weekdays: 'vasárnap_hà©tfÅ‘_kedd_szerda_csà¼tà¶rtà¶k_pà©ntek_szombat'.split('_'),
            weekdaysShort: 'vas_hà©t_kedd_sze_csà¼t_pà©n_szo'.split('_'),
...
// moment.js locale configuration
// locale : icelandic (is)
// author : Hinrik à–rn Sigurà°sson : https://github.com/hinrik
    ...
    (function (factory) {
        ...
        function translate(number, withoutSuffix, key, isFuture) {
            ...
            switch (key) {
                case 's':
                    return withoutSuffix || isFuture ? 'nokkrar sekàºndur' : 'nokkrum sekàºndum';
                case 'm':
                    return withoutSuffix ? 'mà­nàºta' : 'mà­nàºtu';
                case 'mm':
                    if (plural(number)) {
                        return result + (withoutSuffix || isFuture ? 'mà­nàºtur' : 'mà­nàºtum');
                    } else if (withoutSuffix) {
                        return result + 'mà­nàºta';
                    }
                    return result + 'mà­nàºtu';
                case 'hh':
                    if (plural(number)) {
                ...
                case 'dd':
                    if (plural(number)) {
                        ...
                        return result + (isFuture ? 'daga' : 'dà¶gum');
                    } else if (withoutSuffix) {
                        return result + 'dagur';
                    }
                ...
                case 'M':
                    ...
                    return isFuture ? 'mánuà°' : 'mánuà°i';
                case 'MM':
                    if (plural(number)) {
                        if (withoutSuffix) {
                            return result + 'mánuà°ir';
                        }
                        return result + (isFuture ? 'mánuà°i' : 'mánuà°um');
                    } else if (withoutSuffix) {
                        return result + 'mánuà°ur';
                    }
                    return result + (isFuture ? 'mánuà°' : 'mánuà°i');
                case 'y':
        ...
        return moment.defineLocale('is', {
            months: 'janàºar_febràºar_mars_aprà­l_maà­_jàºnà­_jàºlà­_ágàºst_september_oktà³ber_nà³vember_desember'.split('_'),
            monthsShort: 'jan_feb_mar_apr_maà­_jàºn_jàºl_ágàº_sep_okt_nà³v_des'.split('_'),
            weekdays: 'sunnudagur_mánudagur_à¾rià°judagur_mià°vikudagur_fimmtudagur_fà¶studagur_laugardagur'.split('_'),
            weekdaysShort: 'sun_mán_à¾ri_mià°_fim_fà¶s_lau'.split('_'),
            weekdaysMin: 'Su_Má_àžr_Mi_Fi_Fà¶_La'.split('_'),
            longDateFormat: {
                LT: 'H:mm',
                LTS: 'LT:ss',
                L: 'DD/MM/YYYY',
            ...
            calendar: {
                ...
                nextWeek: 'dddd [kl.] LT',
                lastDay: '[à­ gà¦r kl.] LT',
                lastWeek: '[sà­à°asta] dddd [kl.] LT',
                sameElse: 'L'
            },
            relativeTime: {
                future: 'eftir %s',
                past: 'fyrir %s sà­à°an',
                s: translate,
                m: translate,
                mm: translate,
                h: 'klukkustund',
...
// author: Mattia Larentis: https://github.com/nostalgiaz
    ...
    (function (factory) {
        ...
        return moment.defineLocale('it', {
            ...
            weekdays: 'Domenica_Lunedà¬_Martedà¬_Mercoledà¬_Giovedà¬_Venerdà¬_Sabato'.split('_'),
...
// and 'eifelerRegelAppliesToNumber' methods are meant for
    ...
    (function (factory) {
        ...
        return moment.defineLocale('lb', {
            months: 'Januar_Februar_Mà¤erz_Abrà«ll_Mee_Juni_Juli_August_September_Oktober_November_Dezember'.split('_'),
            monthsShort: 'Jan._Febr._Mrz._Abr._Mee_Jun._Jul._Aug._Sept._Okt._Nov._Dez.'.split('_'),
            weekdays: 'Sonndeg_Mà©indeg_Dà«nschdeg_Mà«ttwoch_Donneschdeg_Freideg_Samschdeg'.split('_'),
            weekdaysShort: 'So._Mà©._Dà«._Mà«._Do._Fr._Sa.'.split('_'),
            weekdaysMin: 'So_Mà©_Dà«_Mà«_Do_Fr_Sa'.split('_'),
            longDateFormat: {
                LT: 'H:mm [Auer]',
                LTS: 'H:mm:ss [Auer]',
                L: 'DD.MM.YYYY',
            ...
            calendar: {
                ...
                nextDay: '[Muer um] LT',
                nextWeek: 'dddd [um] LT',
                lastDay: '[Gà«schter um] LT',
                lastWeek: function () {
                    // Different date string for 'Dà«nschdeg' (Tuesday) and 'Donneschdeg' (Thursday) due to phonological rule
                    switch (this.day()) {
                        case 2:
                        case 4:
...
//           Sigurd Gartmann : https://github.com/sigurdga
    ...
    (function (factory) {
        ...
        return moment.defineLocale('nb', {
            ...
            monthsShort: 'jan_feb_mar_apr_mai_jun_jul_aug_sep_okt_nov_des'.split('_'),
            weekdays: 'sà¸ndag_mandag_tirsdag_onsdag_torsdag_fredag_là¸rdag'.split('_'),
            weekdaysShort: 'sà¸n_man_tirs_ons_tors_fre_là¸r'.split('_'),
            weekdaysMin: 'sà¸_ma_ti_on_to_fr_là¸'.split('_'),
            longDateFormat: {
                LT: 'H.mm',
                LTS: 'LT.ss',
...
// moment.js locale configuration
// locale : dutch (nl)
// author : Joris Rà¶ling : https://github.com/jjupiter
...
// author : https://github.com/mechuwind
    ...
    (function (factory) {
        ...
        return moment.defineLocale('nn', {
            months: 'januar_februar_mars_april_mai_juni_juli_august_september_oktober_november_desember'.split('_'),
            monthsShort: 'jan_feb_mar_apr_mai_jun_jul_aug_sep_okt_nov_des'.split('_'),
            weekdays: 'sundag_mà¥ndag_tysdag_onsdag_torsdag_fredag_laurdag'.split('_'),
            weekdaysShort: 'sun_mà¥n_tys_ons_tor_fre_lau'.split('_'),
            weekdaysMin: 'su_mà¥_ty_on_to_fr_là¸'.split('_'),
            longDateFormat: {
                LT: 'HH:mm',
                LTS: 'LT:ss',
                L: 'DD.MM.YYYY',
            ...
            calendar: {
                ...
                lastDay: '[I gà¥r klokka] LT',
                lastWeek: '[Fà¸regà¥ande] dddd [klokka] LT',
                sameElse: 'L'
            },
            relativeTime: {
                future: 'om %s',
    ...
    (function (factory) {
        ...
        return moment.defineLocale('pt-br', {
            ...
            longDateFormat: {
                ...
                L: 'DD/MM/YYYY',
                LL: 'D [de] MMMM [de] YYYY',
                LLL: 'D [de] MMMM [de] YYYY [à s] LT',
                LLLL: 'dddd, D [de] MMMM [de] YYYY [à s] LT'
            },
            calendar: {
                sameDay: '[Hoje à s] LT',
...
// author : Jefferson : https://github.com/jalex79
    ...
    (function (factory) {
        ...
        return moment.defineLocale('pt', {
            ...
            weekdays: 'domingo_segunda-feira_terça-feira_quarta-feira_quinta-feira_sexta-feira_sábado'.split('_'),
            weekdaysShort: 'dom_seg_ter_qua_qui_sex_sáb'.split('_'),
            weekdaysMin: 'dom_2Âª_3Âª_4Âª_5Âª_6Âª_sáb'.split('_'),
            longDateFormat: {
                LT: 'HH:mm',
                LTS: 'LT:ss',
                L: 'DD/MM/YYYY',
...
// author : Valentin Agachi : https://github.com/avaly
    ...
    (function (factory) {
        ...
        return moment.defineLocale('ro', {
            ...
            weekdays: 'duminicÄƒ_luni_marÈ›i_miercuri_joi_vineri_sà¢mbÄƒtÄƒ'.split('_'),
            weekdaysShort: 'Dum_Lun_Mar_Mie_Joi_Vin_Sà¢m'.split('_'),
            weekdaysMin: 'Du_Lu_Ma_Mi_Jo_Vi_Sà¢'.split('_'),
            longDateFormat: {
                LT: 'H:mm',
                LTS: 'LT:ss',
                L: 'DD.MM.YYYY',
...
// based on work of petrbela : https://github.com/petrbela
    ...
    (function (factory) {
        ...
        var months = 'január_február_marec_aprà­l_máj_jàºn_jàºl_august_september_oktà³ber_november_december'.split('_'),
                monthsShort = 'jan_feb_mar_apr_máj_jàºn_jàºl_aug_sep_okt_nov_dec'.split('_');
        ...
        function translate(number, withoutSuffix, key, isFuture) {
            ...
            switch (key) {
                case 's':  // a few seconds / in a few seconds / a few seconds ago
                    return (withoutSuffix || isFuture) ? 'pár sekàºnd' : 'pár sekundami';
                case 'm':  // a minute / in a minute / a minute ago
                    return withoutSuffix ? 'minàºta' : (isFuture ? 'minàºtu' : 'minàºtou');
                case 'mm': // 9 minutes / in 9 minutes / 9 minutes ago
                    if (withoutSuffix || isFuture) {
                        return result + (plural(number) ? 'minàºty' : 'minàºt');
                    } else {
                        return result + 'minàºtami';
                    }
                    break;
                case 'h':  // an hour / in an hour / an hour ago
                    return withoutSuffix ? 'hodina' : (isFuture ? 'hodinu' : 'hodinou');
                case 'hh': // 9 hours / in 9 hours / 9 hours ago
                    if (withoutSuffix || isFuture) {
                        return result + (plural(number) ? 'hodiny' : 'hodà­n');
                    } else {
                        return result + 'hodinami';
                    }
                    break;
                ...
                case 'dd': // 9 days / in 9 days / 9 days ago
                    if (withoutSuffix || isFuture) {
                        return result + (plural(number) ? 'dni' : 'dnà­');
                    } else {
        ...
        return moment.defineLocale('sk', {
            ...
            calendar: {
                ...
                lastWeek: function () {
                    switch (this.day()) {
                        case 0:
                            return '[minulàº nedeÄ¾u o] LT';
                        case 1:
                        case 2:
                            return '[minulà½] dddd [o] LT';
                        case 3:
                            return '[minulàº stredu o] LT';
                        case 4:
                        case 5:
                            return '[minulà½] dddd [o] LT';
                        case 6:
                            return '[minulàº sobotu o] LT';
                    }
                },
                sameElse: 'L'
            },
...
// moment.js locale configuration
// locale : Albanian (sq)
// author : Flakà«rim Ismani : https://github.com/flakerimi
// author: Menelion Elensàºle: https://github.com/Oire (tests)
// author : Oerd Cukalla : https://github.com/oerd (fixes)
    ...
    (function (factory) {
        ...
        return moment.defineLocale('sq', {
            months: 'Janar_Shkurt_Mars_Prill_Maj_Qershor_Korrik_Gusht_Shtator_Tetor_Nà«ntor_Dhjetor'.split('_'),
            monthsShort: 'Jan_Shk_Mar_Pri_Maj_Qer_Kor_Gus_Sht_Tet_Nà«n_Dhj'.split('_'),
            weekdays: 'E Diel_E Hà«nà«_E Martà«_E Mà«rkurà«_E Enjte_E Premte_E Shtunà«'.split('_'),
            weekdaysShort: 'Die_Hà«n_Mar_Mà«r_Enj_Pre_Sht'.split('_'),
            weekdaysMin: 'D_H_Ma_Mà«_E_P_Sh'.split('_'),
            meridiemParse: /PD|MD/,
            isPM: function (input) {
            ...
            calendar: {
                sameDay: '[Sot nà«] LT',
                nextDay: '[Nesà«r nà«] LT',
                nextWeek: 'dddd [nà«] LT',
                lastDay: '[Dje nà«] LT',
                lastWeek: 'dddd [e kaluar nà«] LT',
                sameElse: 'L'
            },
            relativeTime: {
                future: 'nà« %s',
...
// author : Jens Alm : https://github.com/ulmus
    ...
    (function (factory) {
        ...
        return moment.defineLocale('sv', {
            ...
            monthsShort: 'jan_feb_mar_apr_maj_jun_jul_aug_sep_okt_nov_dec'.split('_'),
            weekdays: 'sà¶ndag_mà¥ndag_tisdag_onsdag_torsdag_fredag_là¶rdag'.split('_'),
            weekdaysShort: 'sà¶n_mà¥n_tis_ons_tor_fre_là¶r'.split('_'),
            weekdaysMin: 'sà¶_mà¥_ti_on_to_fr_là¶'.split('_'),
            longDateFormat: {
                LT: 'HH:mm',
                LTS: 'LT:ss',
                L: 'YYYY-MM-DD',
...
//           Burak YiÄŸit Kaya: https://github.com/BYK
    ...
    (function (factory) {
        ...
        return moment.defineLocale('tr', {
            months: 'Ocak_Åžubat_Mart_Nisan_MayÄ±s_Haziran_Temmuz_AÄŸustos_Eylà¼l_Ekim_KasÄ±m_AralÄ±k'.split('_'),
            monthsShort: 'Oca_Åžub_Mar_Nis_May_Haz_Tem_AÄŸu_Eyl_Eki_Kas_Ara'.split('_'),
            weekdays: 'Pazar_Pazartesi_SalÄ±_à‡arÅŸamba_PerÅŸembe_Cuma_Cumartesi'.split('_'),
            weekdaysShort: 'Paz_Pts_Sal_à‡ar_Per_Cum_Cts'.split('_'),
            weekdaysMin: 'Pz_Pt_Sa_à‡a_Pe_Cu_Ct'.split('_'),
            longDateFormat: {
                LT: 'HH:mm',
                LTS: 'LT:ss',
                L: 'DD.MM.YYYY',
            ...
            ordinalParse: /\d{1,2}'(inci|nci|à¼ncà¼|ncÄ±|uncu|Ä±ncÄ±)/,
            ordinal: function (number) {
                if (number === 0) {  // special case for zero
                    return number + '\'Ä±ncÄ±';
                }
...
// author : Bang Nguyen : https://github.com/bangnk
    ...
    (function (factory) {
        ...
        return moment.defineLocale('vi', {
            ...
            weekdays: 'chá»§ nháº­t_thá»© hai_thá»© ba_thá»© tÆ°_thá»© nÄƒm_thá»© sáu_thá»© báº£y'.split('_'),
            ...
            calendar: {
                sameDay: '[Hà´m nay làºc] LT',
                nextDay: '[Ngà y mai làºc] LT',
                nextWeek: 'dddd [tuáº§n tá»›i làºc] LT',
                lastDay: '[Hà´m qua làºc] LT',
                lastWeek: 'dddd [tuáº§n rá»“i làºc] LT',
                sameElse: 'L'
            },
            relativeTime: {
                future: '%s tá»›i',
