function habilitaIntegracaoCardService() {
	$('button.btn-habilita-int-cs').off('click');
	$('button.btn-habilita-int-cs').on("click", function (e) {
		e.preventDefault();
		var obj = $(this);
		...
		swal({
			...
			text: "Uma vez habilitada, todos os movimentos advindos da provedora dos valores de cartão serão integrados.",
			type: "warning",
