function somaTotaisResumoConvites(){
    const tabelaFormaPagto = ".itens-tabela-demonstrativa table#tabela-resumo_convites";
    const trsTbodyFormaPagto = tabelaFormaPagto + " tbody tr";
    const trsTfootFormaPagto = tabelaFormaPagto + " tfoot tr";
    const casasPreco = $(".resumo_data_convites").data("casas_preco");
    let valAuxiliarItem = 0;
    let valAuxiliarTotal = 0;

    const cifrao = $(".resumo_data_convites").data("cifrao");
    const cifrao_is_prefixo = $(".resumo_data_convites").data("cifrao_is_prefixo");
    const separador_decimal = $(".resumo_data_convites").data("separador_decimal");
    const separador_milhar = $(".resumo_data_convites").data("separador_milhar");
