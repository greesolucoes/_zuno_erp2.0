...
//         var settings = $.extend({}, {
//             title: 'Novo Documento', // Title of the print Document
//             styles: null,            // stylesheets links
//             exclude: null,           // elements to be excluded
//             include: null,           // hidden elements to be included
//             scripts: null,           // scripts links
//             isPrint: 1,              // Define if the page is gonna be printed
//             iconFav: null            // Fav icon page
//         }, options || {});
//
...
//         // Adding scripts
//         if(settings.scripts) {
//             if($.isArray(settings.scripts)) {
//                 $.each(settings.scripts, function(i, val) {
//                     var elem = print_window.document.createElement('script');
//                     elem.src = val;
//                     $(print_window.document).find('head').append(elem);
//                 })
//             } else {
//                 var elem = print_window.document.createElement('script');
//                 elem.src = settings.scripts;
//                 $(print_window.document).find('head').append(elem);
//             }
//         }
//
//         // Closing head HTML and Opening body HTML
