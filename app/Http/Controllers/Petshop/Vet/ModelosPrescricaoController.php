...
class ModelosPrescricaoController extends Controller
{
    ...
    public function store(StoreModeloPrescricaoRequest $request): RedirectResponse
    {
        ...
        try {
            ...
            session()->flash("flash_sucesso", "Modelo de prescrição cadastrado!");
        ...
        return redirect()->route('vet.prescription-models.index');
    }
    ...
    public function update(UpdateModeloPrescricaoRequest $request, int $modeloId): RedirectResponse
    {
        ...
        try {
            ...
            session()->flash("flash_sucesso", "Modelo de prescrição atualizado!");
        } catch (Throwable $exception) {
            session()->flash("flash_erro", "Algo deu errado: " . $exception->getMessage());
            __saveLogError($exception, request()->empresa_id);
        ...
        return redirect()->route('vet.prescription-models.index', $page ? ['page' => $page] : []);
    }
